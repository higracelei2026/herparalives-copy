...
export default function HomePage() {
  return <main className="landing">
    <nav className="topbar home-nav"><a className="brand" href="#top"><span>她</span>的平行人生</a><div className="home-links"><Link href="/create">开始游戏</Link><a href="#intro">游戏介绍</a><a href="#features">玩法亮点</a><a href="#coach">教练顾问</a><a href="#community">点亮社群</a><Link href="/collection">我的图鉴</Link></div></nav>
    ...
    <section className="feature-section" id="features"><p className="eyebrow dark">HOW IT PLAYS</p><h2>一段值得探索的故事，需要时间发生</h2><div className="feature-grid"><article><b>01</b><h3>从你的处境开始</h3><p>输入当下困境，先生成脱敏的虚构角色卡；你的真实隐私处境不会进入故事档案。</p></article><article><b>02</b><h3>先让故事发生</h3><p>人物、关系与压力会被充分展开，选择只出现在真正需要决定的关键节点，并持续影响后续。</p></article><article><b>03</b><h3>回到岔路再走一次</h3><p>旧线路会保留。你可以探索另一种价值与代价，不需要否定已经走过的人生。</p></article></div></section>
    <section className="coach-section" id="coach"><div className="coach-art"><Image src="/images/linan-ch2-v1.png" alt="女性站在城市分岔路线前的手绘场景" fill sizes="(max-width: 760px) 100vw, 46vw" /></div><div><p className="eyebrow">LIFE COACH 人生教练</p><h2>不说教，也不替你决定</h2><p>Coach 只在每章结束后出现一次。它不诊断、不评价成功失败，也不说“你应该”。它会帮助你分开事实、情绪、资源、价值与代价，像一面受过训练的镜子。</p><blockquote>“这是恐惧替你作答，还是价值在发声？”</blockquote></div></section>
